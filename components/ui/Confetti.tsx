...
const PRESETS: Piece[] = [
  ...
  { shape: 'stick',    color: 'lilac',  top: '32%', left: '12%', size: 24, rotate: -28, dur: '9s',   delay: '0.3s', cx: '5px'  },
  ...
  { shape: 'ring',     color: 'lilac',  top: '92%', left: '15%', size: 14, rotate: 0,   dur: '7.5s', delay: '2s',   cx: '-4px' },

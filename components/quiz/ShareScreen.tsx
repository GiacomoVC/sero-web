  ...
  return (
    <div className="relative min-h-[100svh] bg-cream flex flex-col items-center px-6 py-10 overflow-hidden">
      ...
      <div className="relative z-10 mt-4 text-center">
        ...
        <p className="mt-3 text-ink/65 text-base max-w-sm mx-auto leading-relaxed">
          Ahora lo que lo arranca todo: pasa tu link. Para vivir un plan, tu gente tiene que estar.
        </p>
      </div>
      ...
      <div className="relative z-10 mt-8 w-full max-w-sm">
        <div className="flex items-stretch gap-2">
          <div className="flex items-center text-ink/40 flex-shrink-0 text-lg select-none">
            🔗
          </div>
          <div className="flex-1 min-w-0 rounded-xl border-2 border-ink/10 bg-white/80 px-3 py-2.5 text-ink/80 text-sm font-semibold truncate">
            {shortUrl}
          </div>
          <button
            type="button"
            onClick={copyLink}
            className="shrink-0 rounded-xl bg-ink text-white px-3 py-2.5 font-bold text-sm hover:scale-[1.02] active:scale-[0.97] transition-transform"
          ...
          <a
            ...
            className="shrink-0 rounded-xl bg-[#25D366] text-white px-3 py-2.5 flex items-center justify-center hover:scale-[1.02] active:scale-[0.97] transition-transform"
          ...
          <button
            ...
            className="shrink-0 rounded-xl bg-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] text-white px-3 py-2.5 flex items-center justify-center hover:scale-[1.02] active:scale-[0.97] transition-transform"
        ...
        {igCopied && (
          <p className="mt-2 text-center text-ink/50 text-xs animate-step-in">
      ...
      {matches.length > 0 && (
        <div className="relative z-10 mt-10 w-full max-w-sm">
          <h2 className="text-base font-bold text-ink mb-3">¿Son amigos tuyos?</h2>
            ...
            {matches.map((m, idx) => (
              <div key={idx} className="flex items-center gap-3">
                <button
                  ...
                  className={`shrink-0 rounded-full px-4 py-1.5 text-sm font-bold transition-all ${
                    confirmedFriends.has(idx)
                      ? 'bg-plum text-white'
                      : 'bg-white border-2 border-ink/15 text-ink hover:border-plum/40'
                  }`}
                >
                ...
                <span className="text-ink/80 text-sm">
                  ...
                  <span className="text-ink/45"> · {m.commonCount} en común</span>
                </span>
              </div>
            ))}
          </div>
      ...
      {/* ¿Qué sigue? */}
      <div className="relative z-10 mt-10 w-full max-w-sm bg-white/70 rounded-3xl p-6 border border-ink/8 shadow-sm">
        <h2 className="text-base font-bold text-ink mb-3">¿Qué sigue?</h2>
        <div className="space-y-2 text-sm text-ink/65 leading-relaxed">
